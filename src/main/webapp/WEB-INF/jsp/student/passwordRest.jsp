            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form name="reset" class="form-horizontal" role="form" action="/passwordRest" id="editform" method="post" onsubmit="return check()">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="newPassword" id="newPassword1" placeholder="请输入新密码">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="newPassword2" class="col-sm-2 control-label">确认密码</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="checkPassword" id="newPassword2" placeholder="请再次输入新密码">
                                </div>
                            </div>
...
<script>
    function check() {
        ...
        if (reset.checkPassword.value === "" || reset.checkPassword.value === null) {
            alert("请再次输入新密码");
            return false;
        }
        if (reset.newPassword.value !== reset.checkPassword.value) {
            alert("两次填写的密码不一致");
            return false;
        }
    }
